...
//      else
//        ++parent_;
//    throw std::runtime_error("Attemp to dereference an empty enumerator.");
//  }
...
//public:
//  where_neq_enumerator(enumerator<T> &parent, T value) {
////    auto where_enum_ = where_enumerator<T, int*>(parent, [&value](int x) { return x != value; });
//  }
//private:
////  where_enumerator<T, >
//};
